  ...
  container_definitions     = jsonencode([
    {
      ...
      environmentFiles = [
        {
          value = "arn:aws:s3:::${var.bucket_name}/${var.env_file_name}"
          type  = "s3"
        }
      ]
...
resource "aws_ecs_service" "ecs_service" {
  ...
  network_configuration {
    subnets                 = [aws_subnet.var.private_app_subnet_cidr_block_az1, aws_subnet.var.private_app_subnet_cidr_block_az2]
